    ...
    <div className="min-h-screen bg-white font-sans text-slate-900 selection:bg-rose-100">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-md border-b border-slate-50">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <Link href="/login" className="text-sm font-bold text-rose-500 hover:text-rose-600 transition-colors">
            Login
          </Link>
        </div>
      </nav>
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-rose-50 text-rose-500 px-4 py-2 rounded-full text-xs font-bold mb-8 animate-bounce">
            <Sparkles size={14} />
            AI-POWERED PREGNANCY COMPANION
          </div>
          <h1 className="text-5xl md:text-7xl font-black text-slate-900 leading-[1.1] mb-8">
            Build Your <span className="text-rose-500">Family Nest</span> Together.
          </h1>
